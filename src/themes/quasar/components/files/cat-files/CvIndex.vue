        ...
        <div>
          <cv-adaptive-grid-index
            ...
            <template v-if="1" slot="flexi-properties-slot" slot-scope="props">
              <q-item>
                <q-item-section>
                  <q-item-section label class="f-bold text-subtitle2">{{ fLang('id') }}</q-item-section>
                </q-item-section>
                <q-item-label>
              ...
              <q-item>
                <q-item-label>
                  <q-item-section label class="f-bold text-subtitle2">{{ fLang('resource') }}</q-item-section>
