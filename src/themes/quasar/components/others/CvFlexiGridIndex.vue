      ...
      >
        <table class="q-table bordered horizontal-separator striped-even loose w-100" slot="cv-grid-data" >
          ...
          <transition-group
            ...
            v-show="cLtlg"
            tag="div"
            class="row border-all"
            :enter-active-class="pageAnimation"
            :duration="{ enter: 500, leave: 0 }">
            <div class="row col-md-3 col-sm-6 col-xs-12 q-pa-sm" v-for="(gridRow, gridRowKey) in mainGridData.rows" :key="gridRow[rowKey]">
              <div class="row col-xs-12 q-pa-sm">
                <q-list class="w-100 round-borders" >
